...
questions = [
    {"question": "What part of the body helps you bend your leg?", "options": ["Elbow", "Neck", "Knee", "Wrist"], "answer": "Knee"},
    {"question": "What is the knee made of?", "options": ["Wood", "Metal", "Bone and cartilage", "Glass"], "answer": "Bone and cartilage"},
    {"question": "Who takes care of knee problems?", "options": ["Dentist", "Orthopedic doctor", "Chef", "Optometrist"], "answer": "Orthopedic doctor"},
    {"question": "Which activity uses your knees?", "options": ["Typing", "Jumping", "Reading", "Drawing"], "answer": "Jumping"},
    {"question": "What can happen if you fall on your knee?", "options": ["It disappears", "It gets bruised", "It glows", "It sings"], "answer": "It gets bruised"}
]
...
while running:
    ...
    if show_first_level:
        screen.fill(LIGHT_GREEN)  # Sfondo rosso chiaro
        draw_text_centered(screen, "FIRST LEVEL", level_font, DARK_GREEN, screen_height // 2 - 100)  # Testo rosso scuro
        draw_text_centered(screen, "BODY PART: Knee", title_font, DARK_GREEN, screen_height // 2 + 20)
