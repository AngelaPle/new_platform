...
# Domande e risposte
questions = [
    {"question": "What part of the body do we use to grab things?", "options": ["Foot", "Ear", "Hand", "Nose"], "answer": "Hand"},
    {"question": "What are hands made of?", "options": ["Metal", "Bones and muscles", "Plastic", "Wool"], "answer": "Bones and muscles"},
    {"question": "Who takes care of hand injuries?", "options": ["Dentist", "Hand surgeon", "Librarian", "Optician"], "answer": "Hand surgeon"},
    {"question": "Which activity uses your hands?", "options": ["Running", "Typing", "Listening", "Sleeping"], "answer": "Typing"},
    {"question": "What can happen if you don’t wash your hands?", "options": ["They get cleaner", "They grow faster", "They get dirty", "They turn gold"], "answer": "They get dirty"}
]
...
while running:
    ...
    if show_first_level:
        ...
        draw_text_centered(screen, "FIRST LEVEL", level_font, DARK_BROWN, screen_height // 2 - 100)
        draw_text_centered(screen, "BODY PART: Hand", title_font, DARK_BROWN, screen_height // 2 + 20)
