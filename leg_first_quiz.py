...
LIGHT_SKIN_PINK = (255, 218, 185)  # Rosa pelle
...
questions = [
    {"question": "What part of the body helps you stand and walk?", "options": ["Arm", "Leg", "Head", "Foot"], "answer": "Leg"},
    {"question": "What are legs made of?", "options": ["Wood", "Bones and muscles", "Cotton", "Plastic"], "answer": "Bones and muscles"},
    {"question": "Who takes care of leg injuries?", "options": ["Dentist", "Orthopedic doctor", "Teacher", "Chef"], "answer": "Orthopedic doctor"},
    {"question": "Which activity uses your legs?", "options": ["Swimming", "Running", "Writing", "Reading"], "answer": "Running"},
    {"question": "What can happen if you don’t stretch your legs?", "options": ["You get taller", "You get tired", "You get stronger", "You get a headache"], "answer": "You get tired"}
]
...
while running:
    ...
    if show_first_level:
        screen.fill(WHITE)  # Sfondo rosso chiaro
        draw_text_centered(screen, "FIRST LEVEL", level_font, DARK_BLACK, screen_height // 2 - 100)  # Testo rosso scuro
        draw_text_centered(screen, "BODY PART: Leg", title_font, DARK_BLACK, screen_height // 2 + 20)
