...
LIGHT_ACQUA_GREEN = (127, 255, 212)
DARK_AQUA_GREEN = (0, 128, 128)
...
questions = [
    {"question": "Where is the ear located?", "options": ["Arm", "Foot", "Head", "Back"], "answer": "Head"},
    {"question": "What part of the ear helps us hear sounds?", "options": ["Nose", "Cochlea", "Tongue", "Tooth"], "answer": "Cochlea"},
    {"question": "Who takes care of ear and hearing health?", "options": ["Dentist", "Audiologist", "Teacher", "Optician"], "answer": "Audiologist"},
    {"question": "Which sound level is safe for hearing?", "options": ["30 dB", "130 dB", "200 dB", "400 dB"], "answer": "30 dB"},
    {"question": "What can happen if you listen to loud sounds for too long?", "options": ["You hear better", "You get stronger", "You lose hearing", "You see better"], "answer": "You lose hearing"}
]
...
while running:
    ...
    if show_first_level:
        screen.fill(LIGHT_ACQUA_GREEN)
        draw_text_centered(screen, "FIRST LEVEL", level_font, DARK_AQUA_GREEN, screen_height // 2 - 100)
        draw_text_centered(screen, "BODY PART: Ear", title_font, DARK_AQUA_GREEN, screen_height // 2 + 20)
