...
# Domande e risposte
questions = [
    {"question": "What is the primary muscle in the shoulder?", "options": ["Deltoid", "Biceps", "Triceps", "Pectoralis"], "answer": "Deltoid"},
    {"question": "Which joint connects the arm to the body?", "options": ["Elbow", "Shoulder", "Knee", "Wrist"], "answer": "Shoulder"},
    {"question": "What part of the body allows the shoulder to rotate?", "options": ["Rotator cuff", "Biceps", "Triceps", "Deltoid"], "answer": "Rotator cuff"},
    {"question": "What bone forms the shoulder joint?", "options": ["Scapula", "Clavicle", "Humerus", "Radius"], "answer": "Scapula"},
    {"question": "What is the common injury related to the shoulder?", "options": ["Tendonitis", "Fracture", "Sprain", "Dislocation"], "answer": "Dislocation"}
]
...
while running:
    ...
    if show_first_level:
        ...
        draw_text_centered(screen, "BODY PART: Shoulder", title_font, DARK_BLUE, screen_height // 2 + 20)
