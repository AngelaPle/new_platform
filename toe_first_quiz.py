...
questions = [
    {"question": "What part of the body helps you balance while standing?", "options": ["Finger", "Toe", "Nose", "Hand"], "answer": "Toe"},
    {"question": "What are toes made of?", "options": ["Plastic", "Bones and muscles", "Paper", "Cotton"], "answer": "Bones and muscles"},
    {"question": "Who takes care of toe injuries?", "options": ["Dentist", "Podiatrist", "Optometrist", "Hairdresser"], "answer": "Podiatrist"},
    {"question": "Which of these is a toe?", "options": ["Thumb", "Big toe", "Index finger", "Earlobe"], "answer": "Big toe"},
    {"question": "What can happen if you stub your toe?", "options": ["It turns blue", "It sings", "It grows", "It disappears"], "answer": "It turns blue"}
]
...
while running:
    ...
    if show_first_level:
        screen.fill(LIGHT_SKIN_PINK)  # Sfondo rosso chiaro
        draw_text_centered(screen, "FIRST LEVEL", level_font, DARK_SKIN_PINK, screen_height // 2 - 100)  # Testo rosso scuro
        draw_text_centered(screen, "BODY PART: Toe", title_font, DARK_SKIN_PINK, screen_height // 2 + 20)
