...
questions = [
    {"question": "Where is the eye located?", "options": ["Ear", "Nose", "Hand", "Head"], "answer": "Head"},
    {"question": "What are eyes made of?", "options": ["Glass", "Keratin", "Muscle and tissue", "Plastic"], "answer": "Muscle and tissue"},
    {"question": "Who takes care of eye health?", "options": ["Dentist", "Ophthalmologist", "Teacher", "Chef"], "answer": "Ophthalmologist"},
    {"question": "Which is a natural eye color?", "options": ["Purple", "Orange", "Brown", "Silver"], "answer": "Brown"},
    {"question": "What can happen if you don’t take care of your eyes?", "options": ["They sparkle", "They get tired", "They turn blue", "They grow hair"], "answer": "They get tired"}
]
...
while running:
    ...
    if show_first_level:
        ...
        draw_text_centered(screen, "FIRST LEVEL", level_font, DARK_PINK, screen_height // 2 - 100)  # Testo rosso scuro
        draw_text_centered(screen, "BODY PART: Eye", title_font, DARK_PINK, screen_height // 2 + 20)
