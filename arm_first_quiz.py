...
while running:
    ...
    if show_first_level:
        ...
        draw_text_centered(screen, "FIRST LEVEL", level_font, DARK_ORANGE, screen_height // 2 - 100)
        draw_text_centered(screen, "BODY PART: Arm", title_font, DARK_ORANGE, screen_height // 2 + 20)
