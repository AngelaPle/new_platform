...
# Domande e risposte
questions = [
    {"question": "What part of the body do you use to walk?", "options": ["Hand", "Foot", "Eye", "Ear"], "answer": "Foot"},
    {"question": "What is the foot made of?", "options": ["Paper", "Plastic", "Bones and muscles", "Metal"], "answer": "Bones and muscles"},
    {"question": "Who takes care of foot problems?", "options": ["Dentist", "Podiatrist", "Teacher", "Optician"], "answer": "Podiatrist"},
    {"question": "Which activity uses your feet?", "options": ["Dancing", "Writing", "Talking", "Cooking"], "answer": "Dancing"},
    {"question": "What can happen if you walk too much without shoes?", "options": ["Your feet get stronger", "Your feet get tired", "Your hair grows", "Your ears ring"], "answer": "Your feet get tired"}
]
...
while running:
    ...
    if show_first_level:
        ...
        draw_text_centered(screen, "FIRST LEVEL", level_font, DARK_MAROON, screen_height // 2 - 100)  # Testo rosso scuro
        draw_text_centered(screen, "BODY PART: Foot", title_font, DARK_MAROON, screen_height // 2 + 20)
